package com.phone.custom.swing;
...
//    private static final Font NUNITO_FONT;
//    
//    static {
//        Font font = null;
//        try {
//            // Load font from resources
//            InputStream is = MenuButton.class.getResourceAsStream("/fonts/Nunito-Regular.ttf");
//            font = Font.createFont(Font.TRUETYPE_FONT, is).deriveFont(Font.PLAIN, 16);
//        } catch (FontFormatException | IOException e) {
//            e.printStackTrace();
//            font = new Font("Arial", Font.PLAIN, 16); // Fallback to Arial
//        }
//        NUNITO_FONT = font;
//    }
    ...
    private void init() {
        ...
        setFont(new Font("Rasa", Font.PLAIN, 18));
        //setFont(NUNITO_FONT);
